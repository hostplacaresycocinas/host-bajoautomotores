        ...
        {company.whatsapp ? (
          <div className='flex m-5 gap-5 sm:m-20 md:m-28 lg:m-36 w-full max-w-6xl'>
            <article className='w-full text-color-title-light'>
              ...
              <div className='flex gap-2 sm:gap-3 text-sm sm:text-xl font-semibold text-color-primary-light sm:mt-3'>
                <span>#Consultas</span>
            ...
            <article className='w-full flex justify-center items-center'>
              <div>
                <a
                  className='flex gap-1 sm:gap-2 items-center bg-color-primary hover:bg-color-primary-dark transition-colors py-2 sm:py-3 px-3 sm:px-5 text-white font-semibold rounded-sm sm:rounded'
